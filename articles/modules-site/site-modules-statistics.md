<!-- Filename: Help4.x:Site_Modules:_Statistics / Display title:   Módulos do site: Estatísticas -->

## Descrição

O **módulo para estatísticas** mostra informações sobre a instalação do
seu servidor junto com as estatísticas sobre os usuários do site, a
quantidade de artigos em seu banco de dados e a quantidade de links da
web que você fornece.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-statistics-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-statistics-pt-br.png">800px</a>
...
- **Informações do servidor**: (*Mostrar*/*ocultar*). Exibir informações
  do servidor.
- **Informações do site**: (*Mostrar*/*ocultar*). Exibir informações do
  site
- **Contador de visitas**: (*Mostrar*/*ocultar*). Mostrar contador de
  visitas
...
Só porque você *poderia* mostrar as informações do seu servidor, não
significa que você deveria, ou que é uma boa ideia!

## Visualização do site (front-end)

Um exemplo do módulo para estatísticas é mostrado abaixo:

<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-Extensions-Module-Manager-Statistics-example-output-pt-br.png"
class="new"
title="File:Help-4x-Extensions-Module-Manager-Statistics-example-output-pt-br.png">File:Help-4x-Extensions-Module-Manager-Statistics-example-output-pt-br.png</a>
