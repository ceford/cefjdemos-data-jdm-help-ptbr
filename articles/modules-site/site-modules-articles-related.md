<!-- Filename: Help4.x:Site_Modules:_Articles_-_Related / Display title: Módulos do site: Artigos - Relacionados -->

## Descrição

O tipo de módulo **Artigos - Relacionados** mostra uma lista de artigos
que estão relacionados ao artigo que está sendo visualizado pelo usuário
(por exemplo, uma disposição (layout) de artigo, blog ou lista onde o
usuário clicou em um link de artigo). Os artigos são considerados
relacionados entre si se compartilharem pelo menos uma palavra-chave nas
informações de metadados do artigo. As palavras-chave dos artigos são
inseridas na seção de informações de metadados da tela
...
palavras-chave meta. Todas as palavras-chave do artigo em questão são
pesquisadas e comparadas com todas as palavras-chave de todos os outros
artigos publicados...

- **Data**: (*Mostrar*/*Ocultar*). Mostra/oculta a data
...
- **Texto explicativo**: Este módulo exibe outros artigos relacionados
  ao que está sendo visualizado. Essas relações são estabelecidas pelas
  palavras-chave. Todas as palavras-chave do artigo em questão são
  pesquisadas em relação à todas as palavras-chave de todos os outros
  artigos publicados. Por exemplo, você pode ter um artigo sobre
  "Criação de papagaios" e outro sobre "Cacatuas pretas". Se você
  incluir a palavra-chave "papagaio" em ambos os artigos, o módulo
  "Itens relacionados" listará o artigo "Criando papagaios" ao
  visualizar "Cacatuas pretas" e vice-versa.
