<!-- Filename: Help4.x:Site_Modules:_Breadcrumbs / Display title:   Módulos do site: Trilha da navegação -->

## Descrição

O módulo **Trilha da navegação** mostra um conjunto de links,
relacionados à navegação, que ilustram a localização no site e permitem
a navegação de volta.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-breadcrumbs-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-breadcrumbs-pt-br.png">800px</a>
...
- **Mostrar início**: (*Mostrar*/*ocultar*). Mostra ou oculta o elemento
  inicial no caminho.
- **Texto para entrada inicial**: Este texto será mostrado como entrada
  inicial. Se o campo for deixado em branco (vazio), o valor padrão do
  arquivo mod_breadcrumbs.ini da linguagem será usado.
