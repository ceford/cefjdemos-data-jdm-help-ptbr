<!-- Filename: Help4.x:Site_Modules:_Articles_-_Categories / Display title:   Módulos do site: Artigos - Categorias -->

## Descrição

O tipo do módulo **Artigos - Categorias** mostra uma lista contendo as
categorias em uma categoria superior (principal, pai). **Importante**:
Se a categoria superior (principal, pai) não tiver subcategorias, o
módulo não será mostrado.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-articles-categories-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-articles-categories-pt-br.png">800px</a>

## Campos do formulário

- **Título**: O módulo deve ter um título
...
- **Categoria superior (principal, pai)**: (*Artigos-dados para
  ...
  conteúdo*/*Módulos dos usuários*/...). Escolha uma categoria superior
  (principal, pai).
- **Descrições das categorias**: (*Sim*/*não*). Mostrar ou ocultar as
  descrições das categorias.
- **Mostrar número de artigos**: (*Sim*/*não*). Mostrar ou ocultar o
  número de artigos.
- **Mostrar subcategorias**: (*Sim*/*não*). Mostrar ou ocultar as
  subcategorias.
- **\# primeiras subcategorias**: (*Todas*/*1*/*2*/*3*/*4*/*5*/
  *6*/...). Selecione aqui o número de subcategorias em primeiro nível a
  serem mostradas. O padrão é todas.
- **Nível máximo da profundidade**: (*Todos*/*1*/*2*/*3*/*4*/*5*/
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-manager-admin-module-latestactions-advanced-options-pt-br.png"
class="new"
title="File:Help-4x-modules-manager-admin-module-latestactions-advanced-options-pt-br.png">800px</a>
...
visualizações em um site Joomla!.* Módulo das categorias dos artigos
mostrado:

<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-module-manager-articles-categories-frontend-screenshot-pt-br.png"
class="new"
title="File:Help-4x-module-manager-articles-categories-frontend-screenshot-pt-br.png">File:Help-4x-module-manager-articles-categories-frontend-screenshot-pt-br.png</a>

O nome do tipo do módulo para este módulo é "mod_articles_categories".
Ele está relacionado ao componente do conteúdo.
