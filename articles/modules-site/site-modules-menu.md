<!-- Filename: Help4.x:Site_Modules:_Menu / Display title:   Módulos do site: Menus -->

## Descrição

Este módulo **Menus** permite colocar um menu na posição desejada e nas
páginas web desejadas. Um site pode ter mais que um menu em uma única
página e menus diferentes em páginas diferentes.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-menu-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-menu-pt-br.png">800px</a>
...
- **Selecionar menu**: (*Sobre o Joomla!*/*Parques
  ...
  Seleciona um dos menus na lista.
- **Item base**: (*Atual*/*Começando*/*Usando o Joomla!*/*Usando as
  extensões*/*Componentes*/*Componente do conteúdo*/...). Seleciona um
  item dos menus para ser sempre usado como base para a exibição do
  menu. Você deve definir o nível inicial para o mesmo nível ou um nível
  superior ao nível do item base. Isso fará com que o módulo seja
  mostrado em todas as páginas atribuídas. Se "Atual" for selecionado, o
  item ativo no momento será usado como base. Isso faz com que o módulo
  seja mostrado apenas quando o item superior (principal, pai) dos menus
  estiver ativo.
- **Nível inicial**: (*1*/*2*/*3*/*4*/*5*/*6*/*7* /...). Nível para
  iniciar a renderização do menu. Definir os níveis inicial e final para
  o mesmo \# e definir "Mostrar itens submenus" como "sim" mostrará
  apenas o nível em questão.
- **Nível final**: (*Todos*/*1*/*2*/*3*/*4*/*5*/*6* /...). Nível para
  parar a renderização do menu. Se você escolher "Todos", todos os
  níveis serão mostrados dependendo da configuração "Mostrar itens
  submenus".
