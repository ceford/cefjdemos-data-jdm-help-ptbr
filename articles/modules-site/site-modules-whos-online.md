<!-- Filename: Help4.x:Site_Modules:_Who%27s_Online / Display title:   Módulos do site: Quem está online -->

## Descrição

O módulo **Quem está online** exibe os usuários (quantidade) anônimos e
registrados que estão acessando o site no momento.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-whos-online-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-whos-online-pt-br.png">800px</a>
...
- A maioria das pessoas prefere não usar o módulo "Quem está online"
  quando tem poucos visitantes.
- Se você definir o tempo do cache muito longo para este módulo, a
  quantidade relacionada aos visitantes mostrada será incorreta, pois o
  módulo leva em consideração os usuários que visitaram seu site há x
  minutos.
