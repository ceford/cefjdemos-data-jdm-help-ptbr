<!-- Filename: Help4.x:Site_Modules:_Articles_-_Newsflash / Display title: Módulos do site: Artigos - Novidades -->

## Descrição

O módulo **Artigos - Novidades** mostrará um número fixo de artigos em
uma categoria específica ou em um conjunto de categorias.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-articles-newsflash-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-articles-newsflash-pt-br.png">800px</a>

## Campos do formulário

- **Título**: O módulo precisa ter um título
...
- **Mostrar imagens**: (*Sim*/*não*). Mostra as imagens dos artigos.
- **Mostrar os títulos dos artigos**: (*Sim*/*não*). Mostra ou oculta os
  títulos dos artigos.
- **Títulos vinculados**: (*Usar global*/*não*/*sim*). Vincula os
  títulos dos artigos aos artigos.
- **Nível do cabeçalho**: (*h1*/*h2*/*h3*/*h4*/*h5*). Seleciona os
  níveis dos cabeçalhos HTML desejados para os títulos dos artigos.
- **Mostrar separador final**: (*Sim*/*não*). Mostra o separador após o
  último artigo.
- **Link "Ler mais ..."**: (*Mostrar*/*ocultar*). Se estiver definido
  como mostrar, os links "Ler mais ..." serão mostrados se os textos
  principais forem fornecidos para os artigos.
- **Número de artigos**: O número de artigos a serem mostrados neste
  módulo.
- **Artigos destacados**: (Mostrar/ocultar/mostrar apenas artigos
  destacados). Mostra ou oculta artigos designados como destacados.
- **Classificação dos resultados**: (*Datas das publicações*/*datas das
  criações*/*classificação*/*aleatório*). Seleciona a classificação em
  que você deseja que os resultados das consultas sejam apresentados.
...
visualizações em um site Joomla!.*

Módulo "Artigos - Novidades" mostrado:

<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-module-manager-articles-newsflash-frontend-screenshot-pt-br.png"
class="new"
title="File:Help-4x-module-manager-articles-newsflash-frontend-screenshot-pt-br.png">File:Help-4x-module-manager-articles-newsflash-frontend-screenshot-pt-br.png</a>
