<!-- Filename: Help4.x:Site_Modules:_Latest_Users / Display title:   Módulos do site: Usuários mais recentes -->

## Descrição

O módulo **Usuários mais recentes** mostra os usuários que mais
recentemente se registraram no site. Ele mostra o nome como usuário para
que, preferencialmente, o acesso seja restrito a superusuários. O módulo
não deve ser confundido com o "Quem está online", que é mais adequado
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-latest-users-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-latest-users-pt-br.png">800px</a>
