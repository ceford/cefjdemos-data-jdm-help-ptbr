<!-- Filename: Help4.x:Site_Modules:_Feed_Display / Display title:   Módulos do site: Exibição para feed -->

## Descrição

O módulo **Exibição para feed** mostra um feed RSS para notícias de um
site. Este módulo não está relacionado ao componente dos feeds para
notícias ou às disposições para os feeds das notícias e é uma
alternativa que permite que um feed seja exibido em uma posição para
módulo.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-feed-display-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-feed-display-pt-br.png">800px</a>
...
- **Feed RTL**: (*Sim*/*não*). Exibe o feed na direção RTL (da direita
  para esquerda).
- **Título do feed**: (*Mostrar*/*ocultar*). Mostra ou oculta o título
  do feed das notícias.
- **Descrição do feed**: (*Mostrar*/*ocultar*). Mostra ou oculta o texto
  da descrição para todo o feed.
- **Imagem do feed**: (*Mostrar*/*ocultar*). Mostra ou oculta a imagem
  associada ao feed inteiro.
- **Itens do feed**: Insira o número (quantidade) de itens RSS a serem
  mostrados.
- **Descrição do item**: (*Mostrar*/*ocultar*). Mostra ou oculta as
  descrições ou os textos das introduções dos itens RSS individuais.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-Extensions-Module-Manager-Feed-Display-example-output-pt-br.png"
class="new"
title="File:Help-4x-Extensions-Module-Manager-Feed-Display-example-output-pt-br.png">File:Help-4x-Extensions-Module-Manager-Feed-Display-example-output-pt-br.png</a>

O nome do módulo para este módulo é "mod_feed".
