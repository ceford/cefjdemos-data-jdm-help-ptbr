<!-- Filename: Help4.x:Site_Modules:_Language_Switcher / Display title:   Módulos do site: Alternador para linguagens -->

## Descrição

O módulo **Alternador para linguagens** permite alternar entre as li
guagens para conteúdo disponíveis. A seleção de uma linguagem levará
você à página inicial dessa linguagem.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-language-switcher-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-language-switcher-pt-br.png">800px</a>
...
- **Pós-texto**: Este é o texto ou a HTML que aparece embaixo do
  alternador para linguagens.
- **Usar o menu suspenso**: (*Sim*/*não*). Se definido como "sim", os
  parâmetros de exibição abaixo serão ignorados. Os nomes nativos das
  linguagens para conteúdo serão mostrados em uma lista suspensa.
- **Usar as imagens das bandeiras**: (*Sim*/*não*). Se definido como
  "sim", mostrará as opções das linguagens como as imagens das
  bandeiras. Caso não, usará os nomes nativos das linguagens para
  conteúdo.
- **Exibição horizontal**: (*Sim*/*não*). O padrão é definir como "sim",
  ou seja, para mostrar horizontalmente.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help4x-Extensions-Module-Manager-Language-Switcher-example-output-pt-br.png"
class="new"
title="File:Help4x-Extensions-Module-Manager-Language-Switcher-example-output-pt-br.png">File:Help4x-Extensions-Module-Manager-Language-Switcher-example-output-pt-br.png</a>
