<!-- Filename: Help4.x:Site_Modules:_Articles_-_Latest / Display title:   Módulos do site: Artigos - Mais recentes -->

## Descrição

O módulo **Artigos - Mais recentes** mostra uma lista dos artigos
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-articles-latest-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-articles-latest-pt-br.png">800px</a>
...
- **Categoria**: Seleciona artigos em uma ou mais categorias. Se não
  ...
  padrão.
- **Quantidade**: O número dos artigos a serem mostrados (o padrão é 5).
- **Artigos destacados**: (*Mostrar*/*ocultar*/*mostrar somente artigos
  destacados*). Mostrar/ocultar artigos designados como destacados.
- **Classificação**: (*Recentemente adicionados antes*/*recentemente
  modificados antes*/*recentemente publicados antes*/*recentemente
  tocados antes*/*artigos aleatórios*). Recentemente adicionados antes:
  classifica os artigos usando suas datas de criação.

Recentemente modificados antes: classifica os artigos usando suas datas
de modificação. Recentemente publicados antes: classifica os artigos
pelas datas de publicação. Recentemente tocados antes: classifica os
artigos usando suas datas de modificação ou criação.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-Extensions-Module-Manager-Articles-Latest-example-output-pt-br.png"
class="new"
title="File:Help-4x-Extensions-Module-Manager-Articles-Latest-example-output-pt-br.png">File:Help-4x-Extensions-Module-Manager-Articles-Latest-example-output-pt-br.png</a>

O nome do tipo do módulo para isso é "mod_articles_latest". Ele não está
relacionado a nenhum outro componente.
