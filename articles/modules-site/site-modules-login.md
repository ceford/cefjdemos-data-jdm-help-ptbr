<!-- Filename: Help4.x:Site_Modules:_Login / Display title:   Módulos do site: Sessões -->

## Descrição

O módulo **Sessões** exibe um formulário para o início das sessões com
campos para nomes de usuários e senhas. Ele também mostra um link para
recuperar senhas esquecidas. Se o registro para usuários estiver
habilitado nas configurações para usuários na tela das configurações
globais, o link "Criar uma conta" será mostrado para convidar os
usuários a se registrarem.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-login-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-login-pt-br.png">800px</a>
...
- **Pós-texto**: Este é o texto ou HTML mostrado abaixo do formulário
  para início das sessões.
- **Página para redirecionamento após o início das sessões**:
  (*Padrão*/*Começando*/*Usando o Joomla!*/*Usando as
  extensões*/*Componentes*/*Componente do conteúdo* /...). Define a
  página para a qual os usuários serão redirecionados após um início da
  sessão bem-sucedido. Selecione entre todas as páginas listadas no menu
  suspenso. Escolher "Padrão" retornará à mesma página.
- **Página para redirecionamento após o término das sessões**:
  (*Padrão*/*Começando*/*Usando o Joomla!*/*Usando as
  extensões*/*Componentes*/*Componente do conteúdo* /...). Define a
  página para a qual os usuários serão redirecionados após o término das
  sessões. Selecione entre todas as páginas listadas no menu suspenso.
  Escolher "Padrão" retornará à mesma página.
- **Mostrar saudação**: (*Mostrar*/*ocultar*). Mostra ou oculta o texto
  simples para saudação.
- **Mostrar o nome ou o nome como usuário**: (*Nome*/*nome como
  usuário*). Mostra o nome ou o nome como usuário após o início da
  sessão.
- **Link do perfil**: (*Mostrar*/*ocultar*). Mostra ou oculta o link
...
Nenhuma dica foi adicionada no momento.
