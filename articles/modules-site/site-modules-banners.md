<!-- Filename: Help4.x:Site_Modules:_Banners / Display title:   Módulos do site: Banners -->

## Descrição

O módulo **Banners** exibe os banners ativos no componente.
...
<a
href="https://docs.joomla.org/index.php?title=Special:Upload&amp;wpDestFile=Help-4x-modules-site-module-manager-module-banners-pt-br.png"
class="new"
title="File:Help-4x-modules-site-module-manager-module-banners-pt-br.png">800px</a>
...
- **Quantidade**: (*1*/*2*/*3*/*4*/*5*/*6*/*7*/...). O número de banners
  a serem mostrados (padrão 5).
- **Cliente**: (*Nenhum cliente*/*livraria*/*Joomla!*/*loja*). Seleciona
  apenas os banners pertecentes a um único cliente.
- **Categoria(s)**: Seleciona os banners em uma categoria específica ou
  em um conjunto de categorias. Se não houver nenhuma seleção, todas as
  categorias serão exibidas como padrão.
- **Pesquisar por meta palavras-chaves**: (*Sim*/*não*). O banner é
  selecionado combinando as tags do banner com as meta palavras-chaves
  do documento atual.
- **Aleatorização**: (*Fixado, ordenar*/*fixado, aleatorizar*).
  Aleatoriza a classificação (ordem) dos banners.
- **Texto do cabeçalho**: Texto ou HTML a ser mostrado antes do grupo
  dos banners.
