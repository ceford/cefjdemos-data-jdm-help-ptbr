<!-- Filename: Help4.x:Maintenance:_Clear_Cache  / Display title: Manutenção: Limpar Cache -->
...
![Manutenção Limpar Cache](../../../pt/images/maintenance/maintenance-clear-cache/01-cache-list.png)
