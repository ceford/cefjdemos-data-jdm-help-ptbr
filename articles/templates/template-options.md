<!-- Filename: Help4.x:Template:_Options  / Display title: Modelo: Opções -->
...
![opções de modelos guia de modelos](../../../pt/images/templates/template-options/01-templates-tab.png)
