<!-- Filename: Help4.x:Contacts:_Options  / Display title: Contatos: Opções -->
...
![Captura de tela das opções de contatos](../../../pt/images/contacts/contacts-options/01-contact-tab.png)
...
- **Celular** Exibe ou oculta o número do celular.
...
![Aba de ícones das opções de contatos](../../../pt/images/contacts/contacts-options/02-icons-tab.png)
...
![Aba de categoria das opções de contatos](../../../pt/images/contacts/contacts-options/03-category-tab.png)
...
![Aba de categorias das opções de contatos](../../../pt/images/contacts/contacts-options/04-categories-tab.png)
...
![Aba de layouts de lista das opções de contatos](../../../pt/images/contacts/contacts-options/05-list-layouts-tab.png)
...
![Aba formulário das opções de contatos](../../../pt/images/contacts/contacts-options/06-form-tab.png)
