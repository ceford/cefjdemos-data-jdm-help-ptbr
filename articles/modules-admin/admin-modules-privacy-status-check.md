<!-- Filename: Help4.x:Admin_Modules:_Privacy_Status_Check  / Display title: Módulos: Verificação de Status de Privacidade -->
...
![módulos guia do módulo de verificação de status de privacidade](../../../pt/images/modules-admin/admin-modules-privacy-status-check/01-module-tab.png)
