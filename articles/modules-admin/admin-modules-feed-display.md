<!-- Filename: Help4.x:Admin_Modules:_Feed_Display  / Display title: Módulos: Exibição de Feed -->
...
![modules feed display module tab](../../../ptbr/images/modules-admin/admin-modules-feed-display/01-modules-feed-display-module-tab.png)
