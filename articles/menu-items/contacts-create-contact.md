<!-- Filename: Help4.x:Menu_Item:_Create_Contact  / Display title: Criar Contato -->
...
![Item do Menu Criar Contato](../../../pt/images/menu-items/contacts-create-contact/01-details-tab.png)
