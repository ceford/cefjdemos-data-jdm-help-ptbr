<!-- Filename: Help4.x:Menu_Item:_Registration_Form  / Display title: Formulário de Registro -->
...
![Aba de detalhes do formulário de registro](../../../pt/images/menu-items/users-registration-form/01-details-tab.png)
