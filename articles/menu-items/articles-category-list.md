<!-- Filename: Help4.x:Menu_Item:_Category_List  / Display title: Lista de Categorias -->
...
![Lista de Categorias de Itens de Menu](../../../ptbr/images/menu-items/articles-category-list/01-articles-category-list-details-tab.png)
