<!-- Filename: Help4.x:Menu_Item:_Logout  / Display title: Sair -->
...
![Aba de detalhes de logout](../../../pt/images/menu-items/users-logout/01-details-tab.png)

## Campos de Formulário

### Aba de Opções

![Aba de opções de logout](../../../pt/images/menu-items/users-logout/02-options-tab.png)
