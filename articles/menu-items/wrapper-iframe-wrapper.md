...
![Aba de detalhes do wrapper iframe](../../../pt/images/menu-items/wrapper-iframe-wrapper/01-details-tab.png)

## Campos do Formulário

### Aba de Parâmetros da Barra de Rolagem

![Aba de parâmetros da barra de rolagem do wrapper do Iframe](../../../pt/images/menu-items/wrapper-iframe-wrapper/02-scroll-bar-parameters-tab.png)
...
![Aba avançada do wrapper do Iframe](../../../pt/images/menu-items/wrapper-iframe-wrapper/03-advanced-tab.png)
