<!-- Filename: Help4.x:Menu_Item:_Confirm_Request  / Display title: Item do Menu: Confirmar Solicitação -->
...
![Detalhes da Solicitação de Confirmação de Privacidade do Item de Menu](../../../pt/images/menu-items/privacy-confirm-request/01-details-tab.png)
