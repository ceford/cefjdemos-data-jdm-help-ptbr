<!-- Filename: Help4.x:Menu_Item:_List_All_Tags  / Display title: Listar Todas as Tags -->
...
![Lista Compacta de Itens Marcados, guia de detalhes](../../../pt/images/menu-items/tags-list-all-tags/01-details-tab.png)

## Campos do Formulário

### Aba de Opções

![Lista Compacta de Itens Marcados aba de detalhes](../../../pt/images/menu-items/tags-list-all-tags/02-options-tab.png)
...
![Lista Compacta de Itens Marcados aba de detalhes](../../../pt/images/menu-items/tags-list-all-tags/03-selection-options-tab.png)
