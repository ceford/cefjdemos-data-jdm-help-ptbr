<!-- Filename: Help4.x:Menu_Item:_Create_Request  / Display title: Item de Menu: Criar Solicitação -->
...
![Item de Menu "Detalhes da Solicitação de Privacidade"](../../../pt/images/menu-items/privacy-create-request/01-details-tab.png)
