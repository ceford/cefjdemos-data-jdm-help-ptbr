<!-- Filename: Help4.x:Menu_Item:_Single_News_Feed  / Display title: Feed de Notícias Único -->
...
![Detalhes da aba de um item de menu com feed de notícias único](../../../pt/images/menu-items/news-feeds-single-news-feed/01-details-tab.png)
...
![Guia de detalhes do item do menu feed de notícias único](../../../pt/images/menu-items/news-feeds-single-news-feed/02-display-options-tab.png)
