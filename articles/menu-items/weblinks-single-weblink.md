<!-- Filename: Help4.x:Menus_Menu_Item_Single_Weblink  / Display title: Único Link da Web -->
...
![Item de menu enviar um link da web](../../../pt/images/menu-items/weblinks-single-weblink/01-details-tab.png)
