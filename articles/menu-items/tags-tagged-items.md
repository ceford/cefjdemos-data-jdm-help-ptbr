<!-- Filename: Help4.x:Menu_Item:_Tagged_Items  / Display title: Itens Marcados -->
...
![Etiqueta da aba de detalhes dos Itens Marcados](../../../pt/images/menu-items/tags-tagged-items/01-details-tab.png)

## Campos do Formulário

### Aba de Opções de Tag

![Aba de detalhes de itens marcados](../../../pt/images/menu-items/tags-tagged-items/02-tag-options-tab.png)
...
![Aba de detalhes de itens marcados](../../../pt/images/menu-items/tags-tagged-items/03-item-options-tab.png)
...
![Aba de detalhes de itens marcados](../../../pt/images/menu-items/tags-tagged-items/04-pagination-options-tab.png)
...
![Aba de detalhes de itens marcados](../../../pt/images/menu-items/tags-tagged-items/05-item-selection-options-tab.png)
