...
![Plug-in de confirmação de consentimento de conteúdo](../../../en/images/plugins/plugin-group-content/01-confirm-consent.png)
...
![Plug-in de contato de conteúdo](../../../en/images/plugins/plugin-group-content/02-contact.png)
...
![Plug-in de ocultação de e-mail de conteúdo](../../../en/images/plugins/plugin-group-content/03-email-cloaking.png)
...
![Plug-in de conteúdo Joomla](../../../en/images/plugins/plugin-group-content/04-joomla.png)
...
![Plug-in de carregamento de módulos de conteúdo](../../../en/images/plugins/plugin-group-content/05-load-modules.png)
...
![Plug-in de quebra de página de conteúdo](../../../en/images/plugins/plugin-group-content/06-page-break.png)
...
![Descrição da quebra de página de conteúdo](../../../en/images/plugins/plugin-group-content/07-page-break-description.png)
...
![Plug-in de navegação de página de conteúdo](../../../en/images/plugins/plugin-group-content/08-page-navigation.png)
...
![Plug-in de votação de conteúdo](../../../en/images/plugins/plugin-group-content/09-vote.png)
