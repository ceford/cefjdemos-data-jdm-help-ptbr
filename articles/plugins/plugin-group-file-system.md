<!-- Filename: Chunk4x:Extensions_Plugin_Manager_Edit_FileSystem_Group  / Display title: Grupo de Sistema de Arquivos -->
...
![formulário do plugin do sistema de arquivos local](../../../en/images/plugins/plugin-group-file-system/01-plugin-group-file-system-local.png)
