...
![Formulário de criador de contato do usuário](../../../en/images/plugins/plugin-group-user/01-contact-creator.png)
...
![Formulário de token da api do usuário joomla](../../../en/images/plugins/plugin-group-user/02-joomla-api-token.png)
...
![Formulário do usuário joomla](../../../en/images/plugins/plugin-group-user/03-joomla.png)
...
![Formulário de perfil do usuário](../../../en/images/plugins/plugin-group-user/04-profile.png)
...
![Formulário de termos e condições do usuário](../../../en/images/plugins/plugin-group-user/05-terms-and-conditions.png)
