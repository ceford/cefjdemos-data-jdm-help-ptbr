...
![Formulário de recursos adicionais de acessibilidade do sistema](../../../en/images/plugins/plugin-group-system/01-plugin-group-system-additional-accessibility-features.png)
...
![Aba do plugin no formulário de depuração do sistema](../../../en/images/plugins/plugin-group-system/02-plugin-group-system-debug-plugin-tab.png)
...
![Aba de idioma no formulário de depuração do sistema](../../../en/images/plugins/plugin-group-system/03-plugin-group-system-debug-language-tab.png)
...
![Aba de registro no formulário de depuração do sistema](../../../en/images/plugins/plugin-group-system/04-plugin-group-system-debug-logging-tab.png)
...
![Formulário de cabeçalhos HTTP do sistema](../../../en/images/plugins/plugin-group-system/05-plugin-group-system-http-headers.png)
...
![Formulário de agendador de tarefas do sistema](../../../en/images/plugins/plugin-group-system/06-plugin-group-system-job-scheduler.png)
...
![Formulário de estatísticas do Joomla! do sistema](../../../en/images/plugins/plugin-group-system/07-plugin-group-system-joomla-statistics.png)
...
![Formulário de notificação de atualização do Joomla! do sistema](../../../en/images/plugins/plugin-group-system/08-plugin-group-system-joomla-update-notification.png)
...
![Formulário de filtro de idioma do sistema](../../../en/images/plugins/plugin-group-system/09-plugin-group-system-language-filter.png)
...
![Formulário de rotação de logs do sistema](../../../en/images/plugins/plugin-group-system/10-plugin-group-system-log-rotation.png)
...
![Formulário de cache de página do sistema](../../../en/images/plugins/plugin-group-system/11-plugin-group-system-page-cache.png)
...
![Formulário de consentimento de privacidade do sistema](../../../en/images/plugins/plugin-group-system/12-plugin-group-system-privacy-consent.png)
...
![Aba de expiração do formulário de consentimento de privacidade do sistema](../../../en/images/plugins/plugin-group-system/13-plugin-group-system-privacy-consent-expiration.png)
...
![Formulário de redirecionamento do sistema](../../../en/images/plugins/plugin-group-system/14-plugin-group-system-redirect.png)
...
![Formulário de SEF do sistema](../../../en/images/plugins/plugin-group-system/15-plugin-group-system-sef.png)
...
![Formulário de limpeza de dados de sessão do sistema](../../../en/images/plugins/plugin-group-system/16-plugin-group-system-session-data-purge.png)
...
![Formulário de pular para navegação do sistema](../../../en/images/plugins/plugin-group-system/17-plugin-group-system-skip-to-navigation.png)

### Sistema - Registro de Ações do Usuário

![Formulário de registro de ações do usuário do sistema](../../../en/images/plugins/plugin-group-system/18-plugin-group-system-user-actions-log.png)
...
![Formulário de registro de usuário do sistema](../../../en/images/plugins/plugin-group-system/19-plugin-group-system-user-log.png)
