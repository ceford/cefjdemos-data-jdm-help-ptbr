...
![Formulário de recursos adicionais de acessibilidade do sistema](../../../en/images/plugins/plugin-group-system/01-additional-accessibility-features.png)
...
![Aba do plugin no formulário de depuração do sistema](../../../en/images/plugins/plugin-group-system/02-debug-plugin-tab.png)
...
![Aba de idioma no formulário de depuração do sistema](../../../en/images/plugins/plugin-group-system/03-debug-language-tab.png)
...
![Aba de registro no formulário de depuração do sistema](../../../en/images/plugins/plugin-group-system/04-debug-logging-tab.png)
...
![Formulário de cabeçalhos HTTP do sistema](../../../en/images/plugins/plugin-group-system/05-http-headers.png)
...
![Formulário de agendador de tarefas do sistema](../../../en/images/plugins/plugin-group-system/06-job-scheduler.png)
...
![Formulário de estatísticas do Joomla! do sistema](../../../en/images/plugins/plugin-group-system/07-joomla-statistics.png)
...
![Formulário de notificação de atualização do Joomla! do sistema](../../../en/images/plugins/plugin-group-system/08-joomla-update-notification.png)
...
![Formulário de filtro de idioma do sistema](../../../en/images/plugins/plugin-group-system/09-language-filter.png)
...
![Formulário de rotação de logs do sistema](../../../en/images/plugins/plugin-group-system/10-log-rotation.png)
...
![Formulário de cache de página do sistema](../../../en/images/plugins/plugin-group-system/11-page-cache.png)
...
![Formulário de consentimento de privacidade do sistema](../../../en/images/plugins/plugin-group-system/12-privacy-consent.png)
...
![Aba de expiração do formulário de consentimento de privacidade do sistema](../../../en/images/plugins/plugin-group-system/13-consent-expiration.png)
...
![Formulário de redirecionamento do sistema](../../../en/images/plugins/plugin-group-system/14-redirect.png)
...
![Formulário de SEF do sistema](../../../en/images/plugins/plugin-group-system/15-sef.png)
...
![Formulário de limpeza de dados de sessão do sistema](../../../en/images/plugins/plugin-group-system/16-session-data-purge.png)
...
![Formulário de pular para navegação do sistema](../../../en/images/plugins/plugin-group-system/17-skip-to-navigation.png)

### Sistema - Registro de Ações do Usuário

![Formulário de registro de ações do usuário do sistema](../../../en/images/plugins/plugin-group-system/18-user-actions-log.png)
...
![Formulário de registro de usuário do sistema](../../../en/images/plugins/plugin-group-system/19-user-log.png)
