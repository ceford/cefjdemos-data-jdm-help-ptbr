<!-- Filename: Help6.x:Menu_Item_Associations  / Display title: Associações de Itens do Menu -->
...
![guia de associações de itens de menu](../../../pt/images/menu-items-common/menu-item-associations/01-associations-tab.png)
