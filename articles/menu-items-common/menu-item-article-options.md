<!-- Filename: Help6.x:Menu_Item_Article_Options  / Display title: Opções de Artigo do Item de Menu -->
...
![detalhes do item do menu na aba](../../../pt/images/menu-items-common/menu-item-article-options/01-options-tab.png)
