<!-- Filename: Help6.x:Menu_Item_Blog_Layout  / Display title: Layout do Item de Menu Blog -->
...
![Item de Menu guia de layout do blog](../../../pt/images/menu-items-common/menu-item-blog-layout/01-blog-layout-tab.png)
