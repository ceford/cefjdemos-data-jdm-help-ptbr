<!-- Filename: Help4.x:Extensions:_Update  / Display title: Extensões: Atualização -->
...
![Lista de atualização de extensões](../../../pt/images/extensions/extensions-update/01-update-list.png)
