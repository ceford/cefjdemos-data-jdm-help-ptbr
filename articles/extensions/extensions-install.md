...
![Aba de envio de arquivo do pacote de instalação da extensão](../../../pt/images/extensions/extensions-install/01-upload-package-file.png)
...
![Instalação da extensão a partir da aba de pasta](../../../pt/images/extensions/extensions-install/02-install-from-folder.png)
...
![Instalar extensão da guia url](../../../pt/images/extensions/extensions-install/03-install-from-url.png)
...
![Instalação da extensão a partir da guia web](../../../pt/images/extensions/extensions-install/04-install-from-web.png)
