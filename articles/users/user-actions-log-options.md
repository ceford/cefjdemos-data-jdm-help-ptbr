<!-- Filename: Help4.x:User_Actions_Log:_Options  / Display title: Registro de Ações do Usuário: Opções -->
...
![opções de registro de ações do usuário na aba opções](../../../pt/images/users/user-actions-log-options/01-options-tab.png)
