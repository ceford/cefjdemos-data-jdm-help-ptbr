<!-- Filename: Help4.x:User_Notes:_New_or_Edit_Category  / Display title: Notas do Usuário: Nova ou Editar Categoria -->
...
![lista de notas do usuário](../../../pt/images/users/user-notes-new-or-edit-category/01-category-tab.png)
