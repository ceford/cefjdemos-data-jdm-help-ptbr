<!-- Filename: Help4.x:Guided_Tours:_Options  / Display title: Passeios Guiados: Opções -->
...
![Opções de tours guiados](../../../ptbr/images/guided-tours/guided-tours-options/01-guided-tours-options.png)
